...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v5, v6}, Landroid/support/v8/renderscript/Sampler$Value;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v1, v7, v5}, Landroid/support/v8/renderscript/Sampler$Value;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v1, v6, v7}, Landroid/support/v8/renderscript/Sampler$Value;-><init>(Ljava/lang/String;II)V
    ...
    new-array v1, v1, [Landroid/support/v8/renderscript/Sampler$Value;

    sget-object v9, Landroid/support/v8/renderscript/Sampler$Value;->NEAREST:Landroid/support/v8/renderscript/Sampler$Value;

    aput-object v9, v1, v2

    sget-object v2, Landroid/support/v8/renderscript/Sampler$Value;->LINEAR:Landroid/support/v8/renderscript/Sampler$Value;

    aput-object v2, v1, v3

    sget-object v2, Landroid/support/v8/renderscript/Sampler$Value;->LINEAR_MIP_LINEAR:Landroid/support/v8/renderscript/Sampler$Value;

    aput-object v2, v1, v4

    sget-object v2, Landroid/support/v8/renderscript/Sampler$Value;->LINEAR_MIP_NEAREST:Landroid/support/v8/renderscript/Sampler$Value;

    aput-object v2, v1, v5

    sget-object v2, Landroid/support/v8/renderscript/Sampler$Value;->WRAP:Landroid/support/v8/renderscript/Sampler$Value;
    ...
    sput-object v1, Landroid/support/v8/renderscript/Sampler$Value;->$VALUES:[Landroid/support/v8/renderscript/Sampler$Value;
