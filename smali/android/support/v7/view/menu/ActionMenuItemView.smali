...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lrp;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private final g()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Loq;
    ...
    iget-object v2, v2, Loq;->l:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Loq;->d:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Loq;->m:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Loq;

    iget-object v1, v0, Loq;->d:Ljava/lang/CharSequence;
    ...
    :cond_6
    invoke-static {p0, v2}, Luf;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final a(Loq;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Loq;
    ...
    invoke-virtual {p0, v0, v2, v2, v2}, Lrp;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V

    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->g()V

    invoke-virtual {p1, p0}, Loq;->a(Lpc;)Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lss;

    if-nez p1, :cond_4

    new-instance p1, Lny;

    invoke-direct {p1, p0}, Lny;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lss;
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Loq;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Lom;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Loq;

    invoke-interface {p1, v0}, Lom;->a(Loq;)Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Lrp;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected final onMeasure(II)V
    ...
    invoke-super {p0, v1, v2, v3, v4}, Lrp;->setPadding(IIII)V

    :cond_1
    :goto_0
    invoke-super {p0, p1, p2}, Lrp;->onMeasure(II)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Lrp;->setPadding(IIII)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Lrp;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Loq;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lss;
    ...
    :cond_0
    invoke-super {p0, p1}, Lrp;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public final setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lrp;->setPadding(IIII)V
