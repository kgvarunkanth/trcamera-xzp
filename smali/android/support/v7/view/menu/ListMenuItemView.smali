...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lnf;->r:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Lvw;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lvw;

    move-result-object p2

    const/4 p3, 0x5

    invoke-virtual {p2, p3}, Lvw;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3, v0}, Lvw;->f(II)I
    ...
    invoke-virtual {p2, v0}, Lvw;->a(I)Landroid/graphics/drawable/Drawable;
...
.method public final a()Loq;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Loq;
...
.method public final a(Loq;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Loq;
    ...
    :cond_4
    :goto_2
    iget-object v3, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Loq;

    invoke-virtual {v3}, Loq;->e()Z
    ...
    :cond_c
    :goto_5
    invoke-virtual {p1}, Loq;->d()Z

    move-result v0

    invoke-virtual {p1}, Loq;->c()C
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Loq;

    invoke-virtual {v4}, Loq;->c()C

    move-result v5

    if-eqz v5, :cond_13

    iget-object v6, v4, Loq;->j:Lon;

    iget-object v6, v6, Lon;->a:Landroid/content/Context;
    ...
    iget-object v8, v4, Loq;->j:Lon;

    iget-object v8, v8, Lon;->a:Landroid/content/Context;
    ...
    invoke-static {v7, v4, v8, v9}, Loq;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v7, v4, v2, v8}, Loq;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :goto_f
    iget-object p1, p1, Loq;->l:Ljava/lang/CharSequence;
...
.method protected final onFinishInflate()V
    ...
    invoke-static {p0, v0}, Ljx;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
