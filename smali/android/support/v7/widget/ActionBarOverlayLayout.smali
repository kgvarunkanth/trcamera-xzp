...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p2, p0}, Lpp;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/animation/AnimatorListenerAdapter;

    new-instance p2, Lpq;

    invoke-direct {p2, p0}, Lpq;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->z:Ljava/lang/Runnable;

    new-instance p2, Lpr;

    invoke-direct {p2, p0}, Lpr;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Ljo;
...
.method private static final a(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    iput v0, p0, Lpt;->topMargin:I

    const/4 v0, 0x1

    :cond_1
    iget v1, p0, Lpt;->rightMargin:I
...
.method final a()V
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lrv;
...
.method public final a(Landroid/view/Menu;Lpa;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lrv;

    invoke-interface {v0, p1, p2}, Lrv;->a(Landroid/view/Menu;Lpa;)V
...
.method public final a(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Lrv;->a(Landroid/view/Window$Callback;)V
...
.method public final b(I)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lrv;

    invoke-interface {p1}, Lrv;->f()V
...
.method protected final fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1, v1}, Lwo;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public final bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lpt;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lpt;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Ljo;
...
.method protected final onLayout(ZIIII)V
    ...
    iget v3, v0, Lpt;->leftMargin:I

    add-int/2addr v3, p2

    iget v0, v0, Lpt;->topMargin:I
...
.method protected final onMeasure(II)V
    ...
    iget v2, v0, Lpt;->leftMargin:I

    add-int/2addr v1, v2

    iget v2, v0, Lpt;->rightMargin:I
    ...
    iget v4, v0, Lpt;->topMargin:I

    add-int/2addr v3, v4

    iget v0, v0, Lpt;->bottomMargin:I
    ...
    invoke-static {p0}, Ljx;->n(Landroid/view/View;)I
    ...
    iget v5, v2, Lpt;->leftMargin:I

    iget v6, v2, Lpt;->rightMargin:I
    ...
    iget v5, v2, Lpt;->topMargin:I

    iget v2, v2, Lpt;->bottomMargin:I
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Ljo;

    const/4 p2, 0x0

    invoke-virtual {p1, p3, p2}, Ljo;->a(II)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Lps;

    if-eqz p1, :cond_1

    check-cast p1, Lne;

    iget-object p2, p1, Lne;->n:Lnv;

    if-eqz p2, :cond_1

    invoke-virtual {p2}, Lnv;->b()V

    const/4 p2, 0x0

    iput-object p2, p1, Lne;->n:Lnv;
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Lps;
    ...
    iget-boolean p1, v2, Lne;->m:Z

    if-nez p1, :cond_3

    iput-boolean v4, v2, Lne;->m:Z

    invoke-virtual {v2, v4}, Lne;->e(Z)V
...
.method protected final onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Lps;
