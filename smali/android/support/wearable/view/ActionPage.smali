...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v2, v1}, Lya;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->b:Lya;

    new-instance v2, Lxv;

    invoke-direct {v2, v1}, Lxv;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Lxv;

    const/16 v3, 0x11

    invoke-virtual {v2, v3}, Lxv;->b(I)V

    iget-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Lxv;

    const/4 v4, 0x2

    invoke-virtual {v2, v4}, Lxv;->a(I)V

    sget-object v2, Lwq;->b:[I
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->b:Lya;

    invoke-virtual {v2, v6}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, v15, Lya;->b:Landroid/content/res/ColorStateList;

    iget-object v6, v15, Lya;->a:Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {v6}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v6

    iget-object v15, v15, Lya;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v15, Lya;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v6, v15, Lya;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v15}, Lya;->requestLayout()V

    invoke-virtual {v15}, Lya;->invalidate()V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->b:Lya;
    ...
    iget-object v4, v6, Lya;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_5

    invoke-virtual {v6}, Lya;->invalidate()V

    invoke-virtual {v6}, Lya;->requestLayout()V
    ...
    invoke-virtual {v6, v4}, Lya;->a(I)V
    ...
    iget-object v4, v0, Landroid/support/wearable/view/ActionPage;->b:Lya;

    invoke-virtual {v2, v3, v5}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v6

    invoke-virtual {v4, v6}, Lya;->a(F)V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->a:Lxv;
    ...
    iget-object v15, v6, Lxv;->c:Ljava/lang/CharSequence;
    ...
    iput-object v8, v6, Lxv;->a:Landroid/text/Layout;

    iput-object v4, v6, Lxv;->c:Ljava/lang/CharSequence;

    invoke-virtual {v6}, Lxv;->requestLayout()V

    invoke-virtual {v6}, Lxv;->invalidate()V
    ...
    invoke-virtual {v6}, Lxv;->getContext()Landroid/content/Context;
    ...
    iput-object v15, v6, Lxv;->b:Landroid/content/res/ColorStateList;

    invoke-virtual {v6}, Lxv;->a()V
    ...
    invoke-virtual {v6, v4}, Lxv;->a(I)V
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->a:Lxv;

    invoke-virtual {v2, v4, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    invoke-virtual {v15, v4}, Lxv;->b(I)V
    ...
    invoke-virtual {v15, v4}, Lya;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Lxv;
    ...
    iget-object v2, v1, Lxv;->a:Landroid/text/Layout;

    if-eqz v2, :cond_1c

    iput-object v8, v1, Lxv;->a:Landroid/text/Layout;

    invoke-virtual {v1}, Lxv;->requestLayout()V

    invoke-virtual {v1}, Lxv;->invalidate()V

    :cond_1c
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Lxv;

    invoke-virtual {v1, v14, v12, v13}, Lxv;->a(Ljava/lang/String;II)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Lxv;

    invoke-virtual {v0, v1}, Landroid/support/wearable/view/ActionPage;->addView(Landroid/view/View;)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->b:Lya;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->b:Lya;
    ...
    invoke-virtual {p1, p3, p5, v0, v1}, Lya;->layout(IIII)V
    ...
    iget-object p2, p0, Landroid/support/wearable/view/ActionPage;->a:Lxv;

    iget-object p3, p0, Landroid/support/wearable/view/ActionPage;->b:Lya;

    invoke-virtual {p3}, Lya;->getBottom()I
    ...
    iget-object p5, p0, Landroid/support/wearable/view/ActionPage;->b:Lya;

    invoke-virtual {p5}, Lya;->getBottom()I
    ...
    invoke-virtual {p2, p1, p3, p4, p5}, Lxv;->layout(IIII)V
...
.method protected final onMeasure(II)V
    ...
    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Lya;
    ...
    iget-object v1, v0, Lya;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, v1}, Lya;->measure(II)V

    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Lya;

    invoke-virtual {v0}, Lya;->getMeasuredWidth()I

    move-result v0

    iget-object v1, p0, Landroid/support/wearable/view/ActionPage;->b:Lya;

    invoke-virtual {v1}, Lya;->getMeasuredHeight()I
    ...
    invoke-virtual {v1, v0, v2}, Lya;->measure(II)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->a:Lxv;
    ...
    invoke-virtual {p1, p2, v0}, Lxv;->measure(II)V
...
.method public final setEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Lya;->setEnabled(Z)V
...
.method public final setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v0, p1}, Lya;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public final setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    invoke-virtual {v0, p1}, Lya;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
