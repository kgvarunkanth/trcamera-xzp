...
.field private mComplicationRenderer:Lxi;
...
.field private final mRendererInvalidateListener:Lxg;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lwz;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V
    ...
    invoke-direct {v0, p0}, Lxa;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Lxg;
...
.method public synthetic constructor <init>(Landroid/os/Parcel;Lwy;)V
    .locals 0
...
.method private updateStyleIfRequired()V
    ...
    iget-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxi;
    ...
    invoke-virtual {v1}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxk;
    ...
    invoke-virtual {v2}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxk;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lxi;->a(Lxk;Lxk;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v8, v0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxi;
    ...
    iget-object v6, v8, Lxi;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lxi;->c:Landroid/graphics/Rect;
    ...
    iget-object v3, v8, Lxi;->w:Lxh;

    iget-boolean v6, v3, Lxh;->j:Z
    ...
    iget-object v6, v8, Lxi;->z:Lxk;

    invoke-direct {v3, v6, v12, v4, v5}, Lxh;-><init>(Lxk;ZZZ)V

    iput-object v3, v8, Lxi;->w:Lxh;
    ...
    :cond_2
    iget-object v3, v8, Lxi;->v:Lxh;

    move-object v10, v3

    :goto_2
    iget-object v3, v8, Lxi;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v3, v8, Lxi;->l:Lxn;

    invoke-virtual {v3, v12}, Lxn;->b(I)V

    iget-object v3, v8, Lxi;->l:Lxn;

    iget-object v5, v8, Lxi;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lxi;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v5}, Lxn;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v4}, Lxn;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, v8, Lxi;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v5, v8, Lxi;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v1}, Lxn;->a(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lxi;->l:Lxn;

    invoke-virtual {v1, v12}, Lxn;->b(I)V

    goto :goto_4

    :cond_5
    iget-object v1, v8, Lxi;->m:Lxn;

    invoke-virtual {v1, v4}, Lxn;->a(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lxi;->l:Lxn;

    invoke-virtual {v1, v11}, Lxn;->b(I)V

    :cond_6
    :goto_4
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->save()I

    iget-object v1, v8, Lxi;->c:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v2, v8, Lxi;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, v10, Lxh;->h:Lxk;

    invoke-virtual {v8, v1}, Lxi;->a(Lxk;)I

    move-result v1

    int-to-float v2, v1

    iget-object v3, v8, Lxi;->o:Landroid/graphics/RectF;

    iget-object v4, v10, Lxh;->f:Landroid/graphics/Paint;

    invoke-virtual {v7, v3, v2, v2, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    iget-object v2, v10, Lxh;->h:Lxk;

    iget-object v2, v2, Lxk;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_7

    invoke-virtual {v10}, Lxh;->a()Z

    move-result v2

    if-nez v2, :cond_7

    iget-object v2, v8, Lxi;->i:Lxm;

    iget-object v3, v10, Lxh;->h:Lxk;

    iget-object v3, v3, Lxk;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v2, v3}, Lxm;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v2, v8, Lxi;->i:Lxm;

    iput v1, v2, Lxm;->b:I

    iget-object v1, v8, Lxi;->n:Landroid/graphics/Rect;

    invoke-virtual {v2, v1}, Lxm;->setBounds(Landroid/graphics/Rect;)V

    iget-object v1, v8, Lxi;->i:Lxm;

    invoke-virtual {v1, v7}, Lxm;->draw(Landroid/graphics/Canvas;)V

    :cond_7
    iget-object v1, v8, Lxi;->p:Landroid/graphics/Rect;
    ...
    :cond_8
    iget-object v1, v8, Lxi;->d:Landroid/graphics/drawable/Drawable;
    ...
    :cond_9
    iget-object v3, v8, Lxi;->e:Landroid/graphics/drawable/Drawable;
    ...
    :cond_a
    :goto_5
    iget-object v3, v10, Lxh;->l:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v3}, Landroid/graphics/drawable/Drawable;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v3, v8, Lxi;->p:Landroid/graphics/Rect;
    ...
    :cond_b
    :goto_6
    iget-object v1, v8, Lxi;->q:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxi;->k:Lxm;

    iget-object v3, v8, Lxi;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lxm;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lxi;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Lxi;->g:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lxm;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lxi;->g:Landroid/graphics/drawable/Drawable;
    ...
    :cond_d
    :goto_7
    iget-object v1, v8, Lxi;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    invoke-virtual {v1, v3}, Lxm;->setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    iget-object v2, v2, Lxk;->j:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v2}, Lxm;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v1, v8, Lxi;->k:Lxm;

    iget-object v2, v10, Lxh;->h:Lxk;

    iget-object v3, v8, Lxi;->q:Landroid/graphics/Rect;

    invoke-virtual {v8, v2, v3}, Lxi;->a(Lxk;Landroid/graphics/Rect;)I
    ...
    iget-object v2, v8, Lxi;->q:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Lxm;->setBounds(Landroid/graphics/Rect;)V
    ...
    :cond_f
    :goto_9
    iget-object v1, v8, Lxi;->r:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxi;->j:Lxm;

    iget-object v2, v8, Lxi;->h:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v2}, Lxm;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lxi;->j:Lxm;

    iget-object v2, v10, Lxh;->h:Lxk;

    iget-object v3, v8, Lxi;->r:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lxi;->r:Landroid/graphics/Rect;
    ...
    :cond_10
    iget-object v1, v8, Lxi;->u:Landroid/graphics/RectF;
    ...
    iget-object v2, v8, Lxi;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v1, v10, Lxh;->c:Landroid/graphics/Paint;
    ...
    iget-object v2, v8, Lxi;->u:Landroid/graphics/RectF;
    ...
    iget-object v6, v10, Lxh;->c:Landroid/graphics/Paint;
    ...
    iget-object v6, v10, Lxh;->d:Landroid/graphics/Paint;
    ...
    :cond_12
    iget-object v1, v8, Lxi;->s:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxi;->x:Landroid/text/TextPaint;

    iget-object v2, v10, Lxh;->a:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_13

    iput-object v2, v8, Lxi;->x:Landroid/text/TextPaint;

    iget-object v1, v8, Lxi;->l:Lxn;

    iget-object v2, v8, Lxi;->x:Landroid/text/TextPaint;

    invoke-virtual {v1, v2}, Lxn;->a(Landroid/text/TextPaint;)V

    iget-object v1, v8, Lxi;->l:Lxn;

    iget-boolean v2, v10, Lxh;->i:Z

    invoke-virtual {v1, v2}, Lxn;->a(Z)V

    :cond_13
    iget-object v1, v8, Lxi;->l:Lxn;

    iget-object v2, v8, Lxi;->s:Landroid/graphics/Rect;

    invoke-virtual {v1, v7, v2}, Lxn;->a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    :cond_14
    iget-object v1, v8, Lxi;->t:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxi;->y:Landroid/text/TextPaint;

    iget-object v2, v10, Lxh;->b:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_15

    iput-object v2, v8, Lxi;->y:Landroid/text/TextPaint;

    iget-object v1, v8, Lxi;->m:Lxn;

    iget-object v2, v8, Lxi;->y:Landroid/text/TextPaint;
    ...
    iget-object v2, v8, Lxi;->t:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lxi;->o:Landroid/graphics/RectF;

    iget-object v3, v10, Lxh;->g:Landroid/graphics/Paint;
    ...
    iget-object v3, v10, Lxh;->e:Landroid/graphics/Paint;
...
.method getActiveStyle()Lxk;
    ...
    invoke-virtual {v0}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxk;
...
.method getComplicationRenderer()Lxi;
    .locals 1
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Lxi;->a(Landroid/graphics/Rect;)V
...
.method public onTap(II)Z
    ...
    iget-object v0, v0, Lxi;->b:Landroid/support/wearable/complications/ComplicationData;
...
.method public setComplicationData(Landroid/support/wearable/complications/ComplicationData;)V
    ...
    invoke-virtual {v0, p1}, Lxi;->a(Landroid/support/wearable/complications/ComplicationData;)V
...
.method public setContext(Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxk;

    move-result-object v3

    invoke-direct {v0, v1, v2, v3}, Lxi;-><init>(Landroid/content/Context;Lxk;Lxk;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxi;

    iget-object v1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Lxg;

    iput-object v1, v0, Lxi;->A:Lxg;
    ...
    :cond_2
    invoke-virtual {v0, v1}, Lxi;->a(Ljava/lang/CharSequence;)V

    :goto_1
    iget-object p1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxi;

    iget-boolean v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRangedValueProgressHidden:Z

    invoke-virtual {p1, v0}, Lxi;->a(Z)V
    ...
    invoke-virtual {p1, v0}, Lxi;->a(Landroid/graphics/Rect;)V
...
.method public setNoDataText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lxi;->a(Ljava/lang/CharSequence;)V
...
.method public setRangedValueProgressHidden(Z)V
    ...
    invoke-virtual {v0, p1}, Lxi;->a(Z)V
