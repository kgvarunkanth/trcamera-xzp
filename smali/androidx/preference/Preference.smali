...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Labe;-><init>(Landroidx/preference/Preference;)V

    iput-object p1, p0, Landroidx/preference/Preference;->f:Landroid/content/Context;

    sget-object v1, Labh;->f:[I
    ...
    invoke-static {p1, p2, v2, v2}, Lha;->a(Landroid/content/res/TypedArray;III)V

    const/16 p2, 0x1a

    const/4 p3, 0x6

    invoke-static {p1, p2, p3}, Lha;->a(Landroid/content/res/TypedArray;II)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, Lha;->b(Landroid/content/res/TypedArray;II)Ljava/lang/CharSequence;
    ...
    invoke-static {p1, p2, p3}, Lha;->d(Landroid/content/res/TypedArray;II)I
    ...
    invoke-static {p1, p2, p3, v1}, Lha;->a(Landroid/content/res/TypedArray;III)V

    const/16 p2, 0x23

    const/16 p3, 0x9

    invoke-static {p1, p2, p3, v2}, Lha;->a(Landroid/content/res/TypedArray;III)V

    const/16 p2, 0x15

    const/4 p3, 0x2

    invoke-static {p1, p2, p3, v0}, Lha;->a(Landroid/content/res/TypedArray;IIZ)Z
    ...
    invoke-static {p1, p2, v0, v0}, Lha;->a(Landroid/content/res/TypedArray;IIZ)Z
    ...
    invoke-static {p1, p3, p3, p2}, Lha;->a(Landroid/content/res/TypedArray;IIZ)Z
    ...
    invoke-static {p1, p2, p3, v2}, Lha;->a(Landroid/content/res/TypedArray;IIZ)Z

    const/16 p2, 0x19

    invoke-static {p1, p2, p2, v0}, Lha;->a(Landroid/content/res/TypedArray;IIZ)Z

    const/16 p2, 0x14

    invoke-static {p1, p2, p2, v2}, Lha;->a(Landroid/content/res/TypedArray;IIZ)Z
...
.method public final a(Labf;)V
    .locals 0

    iput-object p1, p0, Landroidx/preference/Preference;->j:Labf;
...
.method public c()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/preference/Preference;->j:Labf;

    if-eqz v0, :cond_0

    invoke-interface {v0, p0}, Labf;->a(Landroidx/preference/Preference;)Ljava/lang/CharSequence;
