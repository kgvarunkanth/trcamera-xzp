...
.field private volatile m:Lkoz;

.field private mResultGuardian:Lkpr;
...
.method constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lkpq;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkpq;
...
.method protected constructor <init>(Lkop;)V
    .locals 2
    ...
    iget-object v0, v0, Lkqi;->a:Lkom;

    iget-object v0, v0, Lkom;->f:Landroid/os/Looper;

    new-instance v1, Lkpq;

    invoke-direct {v1, v0}, Lkpq;-><init>(Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkpq;
...
.method private final b()Lkov;
    ...
    invoke-static {v1, v3}, Lcqh;->a(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkov;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkov;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkow;
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Lkov;
.end method

.method public final a(Ljava/util/concurrent/TimeUnit;)Lkov;
    .locals 3
    ...
    invoke-static {v1, v0}, Lcqh;->a(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, v0}, Lcqh;->a(ZLjava/lang/Object;)V

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b()Lkov;
...
.method public final a(Lkoq;)V
    ...
    invoke-interface {p1, v1}, Lkoq;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final a(Lkov;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkov;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkov;

    invoke-interface {p1}, Lkov;->a()Lcom/google/android/gms/common/api/Status;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkow;

    if-eqz p1, :cond_0

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkpq;

    const/4 v1, 0x2

    invoke-virtual {p1, v1}, Lkpq;->removeMessages(I)V

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkpq;

    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkow;

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b()Lkov;

    move-result-object v2

    invoke-virtual {p1, v1, v2}, Lkpq;->a(Lkow;Lkov;)V
    ...
    instance-of p1, p1, Lkos;

    if-eqz p1, :cond_1

    new-instance p1, Lkpr;

    invoke-direct {p1, p0}, Lkpr;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Lkpr;
    ...
    invoke-interface {v1, v2}, Lkoq;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final a(Lkow;)V
    ...
    invoke-static {v2, v1}, Lcqh;->a(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkpq;

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b()Lkov;

    move-result-object v2

    invoke-virtual {v1, p1, v2}, Lkpq;->a(Lkow;Lkov;)V

    goto :goto_0

    :cond_0
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkow;
...
.method public final c(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Lkov;
